...
![Conv block 과 identity block 의 비교. 왼쪽 conv block 은 64 채널 입력의 skip 경로에 점선으로 그린 1×1 conv 가 들어가고, 오른쪽 identity block 은 256 채널 입력이 아무 연산 없이 덧셈으로 건너간다](images/s340_crop.png)
