...
![Batch normalization 세 단계의 수식. STEP 1 은 batch 의 평균과 분산 계산, STEP 2 는 그 평균과 분산으로 층 입력을 normalize, STEP 3 은 y = γx + β 의 scaling 과 shifting 이고, γ 와 β 는 학습되는 값이라고 적혀 있다](images/s248_crop.png)
